    ...
    return (
      <>
        <div className="flex justify-between items-center w-full">
          {base_asset === "" | "/" ? <div className="w-fit h-full text-red flex item-center">ALL ASSETS</div> : <div className="w-fit h-full text-red flex item-center">SELECTED ASSET : {base_asset.toUpperCase()}</div>}
